...
export default function ComingSoon() {
    return (
        <div className="comingsoon-wrapper" style={{ minHeight: 'calc(100vh - 56px)', marginTop: '56px', background: '#0d0d1a', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '40px', fontFamily: 'Segoe UI, sans-serif' }}>
